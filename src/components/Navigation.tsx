...
const Navigation = () => {
  ...
  // Блокируем скролл страницы, когда открыт оверлей (особенно важно для iOS)
  useEffect(() => {
  ...
  return (
    <>
      {/* nav теперь на слой ниже, чем оверлей */}
      <nav className="fixed top-0 left-0 w-full z-[55] bg-background/90 backdrop-blur-md">
      ...
      <div
        ...
        } ${isMenuOpen ? "bg-background" : ""}`} // сплошной фон, чтобы не «просвечивало»
      >
        {/* Слайдящийся фон-слой (для эффекта) */}
        <div
